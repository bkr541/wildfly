  ...
  try {
    ...
    const firecrawlBody = {
      ...
      formats: [
        {
          type: "json",
          prompt: `Extract flights from departures. Set 'anchor.origin' to ATL. For each flight: 'flight_numbers' is the link text; 'legs.departure_time' is the first column; 'legs.destination' is ONLY the 3-letter IATA code from the parentheses (e.g., extract 'FLL' from 'Fort Lauderdale (FLL)'). Set 'arrival_time', 'total_duration', and all 'fares' to null.`,
          schema: {
            type: "object",
            ...
            properties: {
              ...
              flights: {
                ...
                items: {
                  type: "object",
                  properties: {
                    total_duration: { type: ["string", "null"] },
