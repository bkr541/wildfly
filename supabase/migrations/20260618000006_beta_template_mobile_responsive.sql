-- beta-application-accepted template: mobile-responsive
-- Minimal change — preserves the desktop hero exactly as-is.
-- On mobile (≤600px): background-size switches to cover (image fills the full td),
-- h1 scales from 30px → 20px, padding tightens, card goes edge-to-edge.
-- color-scheme:light only prevents Gmail dark-mode inversion.
...
<head>
  ...
  <style>
    ...
    @media only screen and (max-width:600px) {
      ...
      .wf-cta   { width:100% !important; }
      .wf-cta-a { display:block !important; text-align:center !important; }
    }
  </style>
</head>
<body style="margin:0;padding:0;background-color:#f4f7f5;font-family:Arial,Helvetica,sans-serif;color:#17352b;color-scheme:light only;">
  <!-- Duplicate <style> for Gmail, which strips <head> before rendering -->
  <style>
    :root { color-scheme: light only; }
    @media only screen and (max-width:600px) {
      .wf-outer { padding:0 !important; }
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" class="wf-card" style="max-width:640px;background-color:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #dce8e2;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                  <td style="padding:8px 32px 28px;">
                    <h1 class="wf-h1" style="margin:0;font-family:'Quicksand',Arial,sans-serif;font-size:30px;line-height:1;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#17352b;text-shadow:0 1px 5px rgba(0,0,0,0.28);">
          ...
          <tr>
            <td class="wf-body" style="padding:32px;background-color:#ffffff;">
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="wf-cta" style="margin:0 auto 16px;">
                <tr>
              ...
              <div style="margin:0 0 24px;padding:22px;border-left:4px solid #0f6b4f;background-color:#f8faf9;">
                <div style="margin:0 0 8px;font-size:15px;font-weight:700;color:#17352b;">
