-- ============================================================
-- Update: Add hero background image to beta-applicant-selected template
      ...
      <table role="presentation" class="email-shell" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;background-color:#FFFFFF;border-radius:18px;overflow:hidden;border:1px solid #E1E9E7;box-shadow:0 8px 26px rgba(26,46,46,0.08);">
        ...
        <tr>
          <td class="mobile-pad" style="padding:30px 40px 28px 40px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-radius:18px;overflow:hidden;">
              <tr>
                <td background="{{app_url}}/assets/messaging/template_beta.png" style="padding:28px;background-image:url('{{app_url}}/assets/messaging/template_beta.png');background-size:cover;background-position:center top;background-color:#E9FBF3;border-radius:18px;">
