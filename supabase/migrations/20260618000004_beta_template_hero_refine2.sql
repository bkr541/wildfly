...
--   • Logo anchored to top-left via nested table (padding:28px 32px 0)
--   • "YOUR APPLICATION" / "WAS ACCEPTED" split across two lines (<br>)
--   • Subtitle text color → #17352b (dark body green), no text-shadow
--   • Heading color → #345C5A (admin selected-tab green)
--   • Total hero height reduced by 24px (128px → 104px vertical padding)
          ...
          <tr>
            <td background="{{app_url}}/assets/messaging/template_beta.png" style="padding:0;background-color:#0f6b4f;background-image:linear-gradient(to bottom,rgba(4,32,22,0.28) 0%,rgba(8,52,36,0.14) 60%,rgba(10,58,40,0.06) 100%),url('{{app_url}}/assets/messaging/template_beta.png');background-size:100% auto;background-position:left top;background-repeat:no-repeat;color:#ffffff;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                  <td style="padding:16px 32px 60px;">
                    <h1 style="margin:0 0 10px 0;font-size:28px;line-height:1.15;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#345C5A;text-shadow:0 1px 5px rgba(0,0,0,0.28);">
                      Your application<br>was accepted
                    </h1>
                    <p style="margin:0;font-size:16px;line-height:1.6;font-weight:500;color:#17352b;">
