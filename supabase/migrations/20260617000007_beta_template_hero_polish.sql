-- ============================================================
-- Update: Hero image left-anchor + gradient overlay + text shadows
-- ============================================================
    ...
    <tr>
      <td align="center" style="padding:32px 16px;">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background-color:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #dce8e2;">
          ...
          <tr>
            <td background="{{app_url}}/assets/messaging/template_beta.png" style="padding:32px;background-color:#0f6b4f;background-image:linear-gradient(to bottom,rgba(4,32,22,0.68) 0%,rgba(8,52,36,0.48) 60%,rgba(10,58,40,0.38) 100%),url('{{app_url}}/assets/messaging/template_beta.png');background-size:cover;background-position:left top;background-repeat:no-repeat;color:#ffffff;">
              <img src="{{app_url}}/assets/logo/logo_horizontal.png" width="130" alt="Wildfly" style="display:block;width:130px;max-width:100%;height:auto;margin-bottom:22px;filter:brightness(0) invert(1);opacity:0.92;">
              <h1 style="margin:0 0 10px 0;font-size:28px;line-height:1.15;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#10B981;text-shadow:0 2px 10px rgba(0,0,0,0.55),0 1px 3px rgba(0,0,0,0.4);">
                Your application was accepted
              </h1>
              <p style="margin:0;font-size:16px;line-height:1.6;font-weight:500;color:rgba(255,255,255,0.75);text-shadow:0 1px 4px rgba(0,0,0,0.45);">
