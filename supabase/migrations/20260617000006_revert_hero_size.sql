-- ============================================================
-- Revert: Remove hero height/position overrides from 000005
-- Restores state from 000004 (background image only, no fixed height)
-- ============================================================
    ...
    <tr>
      <td align="center" style="padding:32px 16px;">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background-color:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #dce8e2;">
          ...
          <tr>
            <td background="{{app_url}}/assets/messaging/template_beta.png" style="padding:32px;background-color:#0f6b4f;background-image:url('{{app_url}}/assets/messaging/template_beta.png');background-size:cover;background-position:center top;color:#ffffff;">
              <div style="font-size:13px;font-weight:700;letter-spacing:1.6px;text-transform:uppercase;opacity:0.86;">
                Wildfly Beta Program
              </div>
              <h1 style="margin:10px 0 8px;font-size:30px;line-height:1.2;">
                Your application was accepted
              </h1>
              <p style="margin:0;font-size:16px;line-height:1.6;color:#e6f5ef;">
