      ...
      <div className="flex-1 flex flex-col px-5 pb-4 gap-4 relative z-10 animate-fade-in">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-[#E3E6E6] overflow-hidden">
          {menuItems.map((item, idx) => (
            ...
            >
              <span className="h-8 w-8 rounded-full bg-surface-active flex items-center justify-center mr-3 shrink-0">
                <HugeiconsIcon icon={item.icon} size={14} color="#047857" strokeWidth={1.5} />
              </span>
