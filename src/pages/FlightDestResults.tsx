                        ...
                        if (item.type === "hour") {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="z-10 bg-[#F4F7F7] px-2 py-px rounded-full border border-[#DDE4E4]">
                                 <span className="text-[10px] font-medium text-[#9AABAB] leading-tight tracking-wide">
                                   {h12} {ampm}
                                 </span>
                               </div>
                            </div>
                              ...
                              <div className="text-left w-full px-4 pt-3.5 pb-2">
                                ...
                                <div className="flex items-center justify-between mb-1.5">
                                  ...
                                  <div className="flex items-center gap-2 mb-1">
                                    <span className="text-[17px] font-bold text-[#1a2e2e] leading-none tabular-nums">
                                      {formatTime(depLeg?.departure_time)}
                                    </span>
                                    <div className="flex-1 flex items-center gap-1">
                                      <div className="flex-1 h-px bg-[#C8D5D5]" />
                                      <svg fill="#2D6A4F" className="w-8 h-8 shrink-0" viewBox="-3.2 -3.2 38.40 38.40" xmlns="http://www.w3.org/2000/svg">
                                  ...
                                  <div className="flex items-center justify-between gap-2 mb-2">
                                    ...
                                    <span className="text-[11px] font-semibold text-[#065F46] bg-[#D1FAE5] px-2.5 py-0.5 rounded-full shrink-0">
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="flex items-center justify-center w-full py-2">
                       <div className="bg-[#F4F7F7] px-2 py-px rounded-full border border-[#DDE4E4]">
                           <span className="text-[10px] font-medium text-[#9AABAB] leading-tight tracking-wide">
                              {h12} {ampm}
                           </span>
                         </div>
