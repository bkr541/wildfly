  ...
  const shareModel = useMemo(
    () =>
      buildFlightShareModel({
        ...
        tripType,
        isRoundTrip,
        oneWayFlights: oneWayFlights as unknown as Parameters<typeof buildFlightShareModel>[0]["oneWayFlights"],
        outboundFlights: outboundFlights as unknown as Parameters<typeof buildFlightShareModel>[0]["outboundFlights"],
        returnFlights: returnFlights as unknown as Parameters<typeof buildFlightShareModel>[0]["returnFlights"],
        airportMap,
      }),
  ...
  return (
    <div className="relative flex flex-col h-full bg-[#F1F5F5] overflow-hidden">
                              ...
                              <div className="text-left w-full px-4 pt-3.5 pb-2">
                                ...
                                <div className="flex items-center justify-between mb-1.5">
                                  ...
                                  <div className="grid grid-cols-[1fr_auto_1fr] gap-y-1 mb-1">
                                    ...
                                    <svg fill="#2D6A4F" className="w-8 h-8 shrink-0 justify-self-center" viewBox="-3.2 -3.2 38.40 38.40" xmlns="http://www.w3.org/2000/svg">
      ...
      <FlightResultsShareSheet
        ...
        isGeneratingImage={isGeneratingShare}
        ...
        nativeShareTitle={`${shareModel.originLabel} → ${shareModel.destinationLabel} Flights`}
      />
      ...
      {bookingConfirm && (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center px-5" onClick={() => setBookingConfirm(null)}>
          ...
          <div
            className="relative w-full max-w-xs bg-white rounded-xl shadow-lg p-4 pt-10 flex flex-col items-center overflow-visible border border-[#047857]"
          ...
          >
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 h-12 w-12 rounded-full bg-[#D1FAE5] border-2 border-[#047857] flex items-center justify-center shadow-sm">
              <HugeiconsIcon icon={Directions02Icon} size={22} color="#047857" strokeWidth={1.5} />
            </div>
            <div className="flex flex-col gap-y-1 mb-1 text-center">
              <h2 className="text-lg font-bold text-[#047857]">Redirecting to Frontier</h2>
            ...
            <div className="flex gap-2 mt-3 w-full">
              <button
                ...
                className="w-full h-10 rounded-md text-sm font-medium bg-white text-[#4B5563] border border-[#D1D5DB] hover:bg-[#F4F8F8] hover:text-[#2E4A4A] transition-colors"
              >
                Back
              </button>
              <button
                ...
                className="w-full h-10 rounded-md text-sm font-medium text-white transition-all hover:opacity-90"
                style={{ background: "linear-gradient(135deg, #059669 0%, #10b981 100%)" }}
              >
                Continue
              </button>
