                            ...
                            >
                              ...
                              <div className="text-left w-full px-4 pt-3.5 pb-2">
                                ...
                                <div className="flex items-center justify-between mb-1.5">
                                 ...
                                 {/* Rows 2+3: Dep [time+city] — plane/duration — Arr [time+city] */}
                                 <div className="flex items-center gap-2 mb-2">
                                   {/* Left: dep time + city stacked */}
                                   <div className="flex flex-col items-center">
                                     <span className="text-[22px] font-bold text-[#1a2e2e] leading-none tabular-nums">
                                       {formatTime(depLeg?.departure_time)}
                                     </span>
                                     <span className="text-[13px] text-[#6B7B7B] font-medium leading-tight mt-0.5 text-center">
                                       {originCity}
                                     </span>
                                   </div>
                                   {/* Middle: plane + duration chip */}
                                   <div className="flex-1 flex flex-col items-center gap-1.5">
                                     ...
                                     <span className="text-[11px] font-semibold text-[#065F46] bg-[#D1FAE5] px-2.5 py-0.5 rounded-full">
                                       {formatDuration(flight.total_duration)}
                                     </span>
                                   </div>
                                   {/* Right: arr time + city stacked */}
                                   <div className="flex flex-col items-center">
                                     <span className="text-[22px] font-bold text-[#1a2e2e] leading-none tabular-nums">
