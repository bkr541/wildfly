  ...
  return (
    <BottomSheet open={open} onClose={() => onClose(false)} style={{ top: "5%" }}>
      ...
      <Tabs defaultValue="manage" className="flex-1 flex flex-col min-h-0">
        <TabsList className="w-full h-11 bg-transparent p-0 gap-0 border-b border-[rgba(0,0,0,0.06)] rounded-none flex-shrink-0 mx-0">
          <TabsTrigger
            value="manage"
            className={cn(
              "flex-1 h-11 text-sm font-medium rounded-none transition-all border-b-2 border-transparent bg-transparent flex items-center justify-center",
        ...
        <TabsContent value="manage" className="mt-0 focus-visible:outline-none flex-1 flex flex-col min-h-0">
        ...
        <TabsContent value="explore" className="mt-0 focus-visible:outline-none flex-1 flex items-center justify-center">
