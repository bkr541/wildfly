...
const WorstRoutesCard = ({ routes, limited = false }: Props) => {
    ...
    <div className="rounded-2xl bg-white p-5 flex flex-col" style={{ boxShadow: CARD_SHADOW }}>
      ...
      >
        ...
        <div className="flex-1 ml-2">
          ...
          <p className="text-xs text-[#6B7B7B]">Lowest GoWild itinerary success rate</p>
        </div>
          ...
          {routes.length === 0 ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-[11px] text-[#9CA3AF] mt-1 leading-snug">
                Connecting itineraries count as GoWild-available only when every leg is GoWild-available.
              </p>
            </div>
          )}
        </div>
