...
import { faChevronLeft, faSun, faMoon, faCircleHalfStroke } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <div className="flex flex-col h-full animate-fade-in">
      <header className="relative z-10 flex items-center justify-between px-5 pt-6 pb-2">
        ...
        <h1 className="text-lg font-bold text-[#345C5A] tracking-tight">Appearance</h1>
        <div className="w-10" />
      </header>
